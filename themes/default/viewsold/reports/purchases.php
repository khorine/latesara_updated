    ...
    $(document).ready(function () {
        var oTable = $('#PoRData').dataTable({
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                var gtotal = 0, paid = 0, balance = 0; ntotal=0; vtotal=0;
                for (var i = 0; i < aaData.length; i++) {
                    ntotal += parseFloat(aaData[aiDisplay[i]][8]-aaData[aiDisplay[i]][7]);
                    vtotal += parseFloat(aaData[aiDisplay[i]][7]);
                ...
                nCells[6].innerHTML = currencyFormat(parseFloat(ntotal));
                nCells[7].innerHTML = currencyFormat(parseFloat(vtotal));
			...
			{column_number: 4, filter_default_label: "[<?=lang('PIN #');?>]", filter_type: "text", data: []},
