                                    ...
                                    <div class="btn-group btn-group-justified">
                                        ...
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-success" id="payment">
                                                <i class="fa fa-money"></i> <?="Generate Bill" /*lang('payment')*/; ?>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        ?>
                         ...
                         <div class="form-group">
                              ...
                              <?php
                                ...
                                echo form_dropdown('cashier', $tx, "", 'id="pcashier" class="form-control" required="required"');
                                ?>
    ...
    $(document).ready(function () {
       ...
       $('#validationModal').on('shown.bs.modal', function(e){
        ...
        $(document).on('click', '#submit-sale', function () {
            if($("#pchef :selected").val()=="" || $("#pcashier :selected").val()==""){alert("Select chef/cashier"); return 0;}
