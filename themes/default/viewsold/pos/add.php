                       ...
                       <div class="form-group">
                        ...
                        <div class="font16">
                            <table class="table table-bordered table-condensed table-striped" style="margin-bottom: 0;">
                                <tbody>
                                <tr>
                                    <td width="25%" style="font-size:28px"><?= lang("total_items"); ?></td>
                                    <td width="25%" class="text-right" style="font-size:28px"><span id="item_count">0.00</span></td>
                                    <td width="25%" style="font-size:28px"><?= lang("total_payable"); ?></td>
                                    <td width="25%" class="text-right" style="font-size:28px"><span id="twt">0.00</span></td>
                                </tr>
                                <tr>
                                    <td style="font-size:28px"><?= lang("total_paying"); ?></td>
                                    <td class="text-right" style="font-size:28px"><span id="total_paying">0.00</span></td>
                                    <td style="font-size:28px"><?= lang("change"); ?></td>
                                    <td class="text-right" style="font-size:28px"><span id="balance">0.00</span></td>
                                </tr>
                                </tbody>
                            </table>
                            <div class="clearfix"></div>
