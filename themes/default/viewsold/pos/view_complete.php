...
<div id="wrapper">
    ...
    <div id="receipt-data">
        <div class="text-center">
            ...
            <h3 style="text-transform:uppercase;"><b>Receipt No </b><?= $inv->id; ?></h3>
            <?php
            ...
            <table class="table table-striped table-condensed">
                ...
                <?php } ?>
                  <tr>
                    ...
                    <tr>
                        <th><?= "<b>Change</b>"; ?></th>
                        <th class="text-right"><?= $this->sma->formatMoney($inv->bill_change); ?></th>
                  </tr>
                </tfoot>
            </table>
            <?php
        ...
        <?php $this->sma->qrcode('link', urlencode(site_url('pos/view_complete/' . $inv->id)), 2); ?>
