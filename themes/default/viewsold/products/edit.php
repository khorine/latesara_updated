                        ...
                        <div class="well well-sm">
                            ...
                            <table class="table table-bordered table-condensed table-striped"
                                ...
                                foreach ($product_options as $option) {
                                    echo '<tr><td class="col-xs-3"><input type="hidden" name="attr_id[]" value="' . $option->id . '"><span>' . $option->name . '</span></td><td class="code text-center col-xs-3"><span>' . $option->wh_name . '</span></td><td class="quantity text-center col-xs-2"><span>' . $this->sma->formatNumber($option->wh_qty) . '</span></td><td class="cost text-right col-xs-2">' . $this->sma->formatMoney($option->cost) . '</td><td class="price text-right col-xs-2">' . $this->sma->formatMoney($option->price) . '</td></tr>';
                                }
                            ?>
                            </tbody>
                            </table>
