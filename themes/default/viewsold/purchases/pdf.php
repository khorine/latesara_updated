    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="row padding10">
                <div class="col-xs-5" style="font-weight:18px;font-weight:bold">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped" style="font-size:18px;font-weight:bold">
                    <thead>
                    <tr class="active">
                        <th><?= lang("no"); ?></th>
