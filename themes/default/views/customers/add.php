        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <?= lang("Residence", "rtype") ?>
                        <?php
                        $opts = array('resident' => lang('Resident'),'nonresident' => lang('Non-Resident'));
                        echo form_dropdown('rtype', $opts, (isset($_POST['rtype']) ? $_POST['rtype'] : ($product ? $product->type : '')), 'class="form-control" id="rtype" required="required"');
                        ?>
                    </div>
                    <!--<div class="form-group company">
