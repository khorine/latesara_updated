<?php if ($Owner || $Admin) { ?>
    <ul id="myTab" class="nav nav-tabs">
        ...
        <li class=""><a href="#PI" class="tab-grey"><?= lang('Portions') ?></a></li>
    </ul>
...
<div class="tab-content">
                    ...
                    <ul class="btn-tasks">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu"
                                ...
                                <li><a href="<?= site_url('products/edit/' . $product->id) ?>"><i
                                            class="fa fa-edit"></i> <?= lang('edit') ?></a></li>
                                <li>
                                    <a onclick="window.open('<?= site_url('products/single_barcode/' . $product->id) ?>', 'sma_popup', 'width=900,height=600,menubar=yes,scrollbars=yes,status=no,resizable=yes,screenx=0,screeny=0'); return false;"
                                       href="#"><i class="fa fa-print"></i>  <?= lang('print_barcode') ?></a></li>
                                <li>
                                    <a onclick="window.open('<?= site_url('products/single_label/' . $product->id) ?>', 'sma_popup', 'width=900,height=600,menubar=yes,scrollbars=yes,status=no,resizable=yes,screenx=0,screeny=0'); return false;"
                                       href="#"><i class="fa fa-print"></i>  <?= lang('print_label') ?></a></li>
                                <li><a href="<?= site_url('products/pdf/' . $product->id) ?>"><i
                                            class="fa fa-download"></i> <?= lang('pdf') ?></a></li>
                                <!--<li><a href="<?= site_url('products/excel/' . $product->id) ?>"><i class="fa fa-download"></i> <?= lang('excel') ?></a></li>-->
                                <li><a data-target="#myModal2" data-toggle="modal"
                                       href="<?= site_url('products/add_adjustment/' . $product->id) ?>"><i
                                            class="fa fa-filter"></i>  <?= lang('adjust_quantity') ?></a></li>
                                <li class="divider"></li>
                                <li><a href="#" class="bpo" title="<b><?= $this->lang->line("delete_product") ?></b>"
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="buttons">
                            <div class="btn-group btn-group-justified">
                                <div class="btn-group"><a href="<?= site_url('products/edit/' . $product->id) ?>"
                                                          class="tip btn btn-primary tip"
                                                          title="<?= lang('edit_product') ?>"><i class="fa fa-edit"></i>
                                        <span class="hidden-sm hidden-xs"><?= lang('edit') ?></span></a></div>
                                <div class="btn-group"><a
                                        onclick="window.open('<?= site_url('products/single_barcode/' . $product->id) ?>', 'sma_popup', 'width=900,height=600,menubar=yes,scrollbars=yes,status=no,resizable=yes,screenx=0,screeny=0'); return false;"
                                        href="#" class="tip btn btn-primary" title="<?= lang('barcode') ?>"><i
                                            class="fa fa-print"></i> <span
                                            class="hidden-sm hidden-xs"><?= lang('print_barcode') ?></span></a></div>
                                <div class="btn-group"><a
                                        onclick="window.open('<?= site_url('products/single_label/' . $product->id) ?>', 'sma_popup', 'width=900,height=600,menubar=yes,scrollbars=yes,status=no,resizable=yes,screenx=0,screeny=0'); return false;"
                                        href="#" class="tip btn btn-primary" title="<?= lang('label') ?>"><i
                                            class="fa fa-print"></i> <span
                                            class="hidden-sm hidden-xs"><?= lang('print_label') ?></span></a></div>
                                <div class="btn-group"><a
                                        onclick="window.open('<?= site_url('products/single_label2/' . $product->id) ?>', 'sma_popup', 'width=900,height=600,menubar=yes,scrollbars=yes,status=no,resizable=yes,screenx=0,screeny=0'); return false;"
                                        href="#" class="tip btn btn-primary" title="<?= lang('label_printer') ?>"><i
                                            class="fa fa-print"></i> <span
                                            class="hidden-sm hidden-xs"><?= lang('label_printer') ?></span></a></div>
                                <div class="btn-group"><a href="<?= site_url('products/pdf/' . $product->id) ?>"
                                                          class="tip btn btn-primary" title="<?= lang('pdf') ?>"><i
                                            class="fa fa-download"></i> <span
                                            class="hidden-sm hidden-xs"><?= lang('pdf') ?></span></a></div>
                                ...
                                <div class="btn-group"><a data-target="#myModal2" data-toggle="modal"
                                            ...
                                            class="hidden-sm hidden-xs"><?= lang('adjust_quantity') ?></span></a></div>
                                            <?php } ?>
                                <div class="btn-group"><a href="#" class="tip btn btn-danger bpo"
                                                          title="<b><?= $this->lang->line("delete_product") ?></b>"
                                                          data-content="<div style='width:150px;'><p><?= lang('r_u_sure') ?></p><a class='btn btn-danger' href='<?= site_url('products/delete/' . $product->id) ?>'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button></div>"
    ...
    <div id="PI" class="tab-pane fade">
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw fa fa-file-text-o nb"></i><a target="_blank" href="<?=('products/edit/'.$product->id)?>"><?= $product->name . ' ' . lang('pi'); ?></a>
                </h2>
            </div>
            <div class="box-content">
                <div class="row">
                    <div class="col-lg-12">
                        <p class="introtext"><?php echo lang('list_results'); ?></p>
                                ...
                                <tr><th>Raw Material</th><th>Qty</th><th>Actions</th></tr>  
                                
                                <tr><td>
								
								<?=$portion1->name?></td><td><?=$product->portion1qty?>&nbsp;<?=$portion1->unit?></td><td><a href="#">X</a></td></tr> 
                             
                                    <?php if($product->portion2){ ?>
                                 <tr><td><?=$portion2->name?></td><td><?=$product->portion2qty?>&nbsp;<?=$portion2->unit?></td><td><a href="#">X</a></td></tr> 
                                <?php }?>
                                    <?php if($product->portion3){ ?>
                                  <tr><td><?=$portion3->name?></td><td><?=$product->portion3qty?>&nbsp;<?=$portion3->unit?></td><td><a href="#">Edit</a></td></tr> 
                                <?php }?>
                                    <?php if($product->portion4){ ?>
                                 <tr><td><?=$portion4->name?></td><td><?=$product->portion4qty?>&nbsp;<?=$portion4->unit?></td><td><a href="#">Edit</a></td></tr> 
                                <?php }?>
                                    <?php if($product->portion5){ ?>
                                  <tr><td><?=$portion5->name?></td><td><?=$product->portion5qty?>&nbsp;<?=$portion5->unit?></td><td><a href="#">Edit</a></td></tr> 
                                <?php }?>
								<?php if($product->portion6){ ?>
                                  <tr><td><?=$portion6->name?></td><td><?=$product->portion6qty?>&nbsp;<?=$portion6->unit?></td><td><a href="#">Edit</a></td></tr> 
                                <?php }?>
								<?php if($product->portion7){ ?>
                                  <tr><td><?=$portion7->name?></td><td><?=$product->portion7qty?>&nbsp;<?=$portion7->unit?></td><td><a href="#">Edit</a></td></tr> 
                                <?php }?>
								<?php if($product->portion8){ ?>
                                  <tr><td><?=$portion8->name?></td><td><?=$product->portion8qty?>&nbsp;<?=$portion8->unit?></td><td><a href="#">Edit</a></td></tr> 
                                <?php }?>
								<?php if($product->portion9){ ?>
                                  <tr><td><?=$portion9->name?></td><td><?=$product->portion9qty?>&nbsp;<?=$portion9->unit?></td><td><a href="#">Edit</a></td></tr> 
                                <?php }?>
								<?php if($product->portion10){ ?>
                                  <tr><td><?=$portion10->name?></td><td><?=$product->portion10qty?>&nbsp;<?=$portion10->unit?></td><td><a href="#">Edit</a></td></tr> 
                                <?php }?>
								<?php if($product->portion11){ ?>
                                  <tr><td><?=$portion11->name?></td><td><?=$product->portion11qty?>&nbsp;<?=$portion11->unit?></td><td><a href="#">Edit</a></td></tr> 
                                <?php }?>
								<?php if($product->portion12){ ?>
                                  <tr><td><?=$portion12->name?></td><td><?=$product->portion12qty?>&nbsp;<?=$portion12->unit?></td><td><a href="#">Edit</a></td></tr> 
                                <?php }?>
								<?php if($product->portion13){ ?>
                                  <tr><td><?=$portion13->name?></td><td><?=$product->portion13qty?>&nbsp;<?=$portion13->unit?></td><td><a href="#">Edit</a></td></tr> 
                                <?php }?>
