                        ...
                        <?php if (!$Settings->restrict_user || $Owner || $Admin) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : ""), 'id="slbiller" data-placeholder="' . lang("select") . ' ' . lang("biller") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                        <?php } else {
                                ...
                                <div class="panel-body" style="padding: 5px;">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                foreach ($cashiers as $cashier) {
                                                    $ch[$cashier->id] = $cashier->first_name." ".$cashier->last_name;
                                                }
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php
                                            echo form_dropdown('cashier', $ch, (isset($_POST['cashier']) ? $_POST['cashier'] : $inv->cashier_id), 'id="cashier" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("cashier") . '" required="required" style="width:100%;" ');
                                          //  echo form_input('cashier', (isset($_POST['cashier']) ? $_POST['cashier'] : ""), 'id="cashier" data-placeholder="' . lang("select") . ' ' . lang("cashier") . '" required="required" class="form-control input-tip" style="width:100%;"');
                                            ?>
                                        </div>
                                    </div>
                                </div>
