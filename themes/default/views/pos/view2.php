...
<div id="wrapper">
					<!--Captain Order -->
       <div id="receipt-data-2">
        <div class="text-center">
            <!-- <img src="<?= base_url() . 'assets/uploads/logos/' . $biller->logo; ?>" alt="<?= $biller->company; ?>"> -->
            <h6 style="text-transform:uppercase;"><b><?= $biller->company != '-' ? $biller->company : $biller->name; ?></b></h6>
            <h6 style="text-transform:uppercase;"><b>ORDER NO: </b><?= $inv->id; ?></h6>
            <?php
           // echo "<p>" . $biller->address . " " . $biller->city . " " . $biller->postal_code . "  " . $biller->country .
           ...
           // echo "Chef" . ": " . $inv->chef . "</br>";
            ...
            <table class="table table-striped table-condensed">
                ...
                foreach ($rows as $row) {
                    ...
                    echo '<tr><td colspan="2">#' . $r . ': &nbsp;&nbsp;' . product_name($row->product_name) . ($row->variant ? ' (' . $row->variant . ')' : '') . '<span class="pull-right">*</span></td></tr>';
 ...
 <h6 style="text-transform:uppercase;"><b>UNPAID BILL NO: </b><?= $inv->id; ?></h6>
  ...
  echo '<p>You were served by:'.$soldby->first_name.'&nbsp;'.$soldby->last_name.'</p>';
			...
			<div class="well well-sm" style="text-align: center">
                <?php echo "MPESA BUY GOODS : 686569"; ?>
            </div>
            <?php
            if ($payments) {
                echo '<table class="table table-striped table-condensed"><tbody>';
