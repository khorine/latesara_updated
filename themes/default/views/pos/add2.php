                    ...
                    <div id="leftdiv">
                        ...
                        <div id="left-top">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <?php
                                    echo form_input('count_cust', (isset($_POST['count_cust']) ? $_POST['count_cust'] : ""), 'id="countcustomers" placeholder="Bill Type" required="required" class="form-control pos-input-tip" style="width:100%;"');
                                    ?>
