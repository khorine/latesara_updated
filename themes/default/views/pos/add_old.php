...
<noscript>
    <div class="global-site-notice noscript">
        <div class="notice-inner">
            <p><strong>Java Script seems to be disabled in your browser.</strong><br>You must have Java Script enabled in
                your browser to utilize the functionality of this web-site.</p>
        </div>
    </div>
</noscript>
        ...
        <div class="container">
            ...
            <div class="header-nav">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown">
                        <a class="btn blightOrange pos-tip" id="opened_bills" title="<span><?= lang('suspended_sales') ?></span>" data-placement="bottom" data-html="true" href="<?= site_url('pos/opened_bills') ?>" data-toggle="modal" data-target="#myModal">
                            <i class="fa fa-th"></i>
                        </a>
                    </li>-->
                    <li class="dropdown">
                   ...
                   <!--  <li class="dropdown">
                    ...
                    <?php } ?>
					 <li class="dropdown hidden-xs">
                            <a class="btn bblue pos-tip" title="<?= lang('List_Orders') ?>" data-placement="bottom" href="<?= site_url('pos/sales') ?>">
                            ...
                            <div id="left-bottom">
                                ...
                                <div id="botbuttons" style="text-align:center;">
                                    <input type="hidden" name="biller" id="biller"
                                           value="<?= $pos_settings->default_biller; ?>"/>
                                    ...
                                    <div class="btn-group btn-group-justified">
                                            ...
                                            <div class="btn-group btn-group-justified">
                                                <div class="btn-group">
                                                    <!--<button type="button" class="btn btn-primary" id="print_order">-->
													 <button type="button" class="btn btn-primary" id="payment_order">
                                        ...
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-success" id="payment">
                                                <i class="fa fa-money"></i> <?="Bill & Order" /*lang('payment')*/; ?>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <input type="hidden" name="chef" value="" id="poschef">
                                <input type="hidden" name="cashier" value="" id="poscashier">
                                ...
                                <div id="payment-con">
                                    <?php for ($i = 1; $i <= 5; $i++) { ?>
                                        ...
                                        <input type="hidden" name="mpesa_txn_no[]" id="mpesa_txn_no_val_<?= $i ?>" value=""/>
                                        <input type="hidden" name="cost_center_no[]" id="cost_center_no_val_<?= $i ?>" value=""/>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="payModalLabel"><?= "Finalize Order"//lang('finalize_sale'); ?></h4>
            </div>
                        ...
                        <?php /* if ($Owner || $Admin) { */?>
                            <div class="form-group">
                                ...
                                foreach ($billers as $biller) {
                                    $bl[$biller->id] = $biller->company."-". $biller->name;
                                }
                       ...
                       <!--<div class="form-group">
                              ...
                              <?php
                                ...
                                foreach ($chefs as $chef) {
                                    $tr[$chef->id] = $chef->first_name." ".$chef->last_name;
                                }
                               
                           echo form_dropdown('chef', $tr, "", 'class="form-control" id="pchef" required="required"');       
                             echo form_input('chef', (isset($_POST['chef']) ? $_POST['chef'] : ""), 'id="pchef" data-placeholder="' . $this->lang->line("select") . ' customer " required="required" class="form-control pos-input-tip" style="width:100%;"');     
                        ...
                        <!-- <div class="form-group">
                              ...
                              <?php
                                ...
                                foreach ($cashiers as $cashier) {
                                    $tx[$cashier->id] = $cashier->first_name." ".$cashier->last_name;
                                }
                                echo form_dropdown('cashier', $tx, "", 'id="pcashier" class="form-control required" required="required"');
                                ?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <div class="form-group">
                                                ...
                                                <input name="amount[]" type="text" id="amount_1" value=0
                                        ...
                                        <div class="col-sm-11">
                                            ...
                                            <div class="pcheque_1" style="display:none;">
                                             ...
                                             <div class="pmpesa_1" style="display:none;">
                                                <div class="form-group">MPESA Transaction Number
                                                    <input name="mpesa_txn_no[]" type="text" id="mpesa_txn_no_1"
                                                           class="form-control mpesa_txn_no"/>
                                                </div>
                                            </div>
                                             <div class="pcostcenter_1" style="display:none;">
                                                <div class="form-group">KPLC Cost Center Number
                                                    <input name="cost_center_no[]" type="text" id="cost_center_no_1"
                                                           class="form-control cost_center_no"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
...
<!--<div class="modal" id="validationModal" tabindex="-1" role="dialog" aria-labelledby="prModalLabel" aria-hidden="true">
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
<!--          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
            ...
            <h4 class="modal-title" id="validationModalLabel"><?php "VALIDATION"; ?></h4>
        </div>
...
<!--                <div class="alert alert-danger gcerror-con" style="display: none;">
                ...
                <div class="form-group">
                    <?= "Enter Password"; ?> *
<!--                    <div class="input-group">-->
                        <?php //echo form_input('password', '', 'class="form-control" type="password" id="password"'); ?>
...
<!--                    </div>
                        <div class="input-group">
                            ...
                            <input type="password" required="required" id="password" class="form-control " name="password"/>
                        </div>
                </div>
        </div>
        
           <div class="modal-footer">
                <button type="button" id="validatePassword" class="btn btn-primary"><?= "Validate" ?></button>
            </div>
    </div> 
</div>
</div>-->

<div class="modal fade" id="tablesdiv" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  if($table->payment_status == 'due'){ ?>
		<button class="btn-prni btn-danger tablebtn1" data-dismiss="modal" value="<?php  echo $table->id;?>"> <?php  echo $table->name;?></button>  
	 <?php }
	 else{ ?>
	<button class="btn-prni btn-success tablebtn1" data-dismiss="modal" value="<?php  echo $table->id;?>"> <?php  echo $table->name;?></button>	 
	 <?php }
	  } ?>
...
<div class="modal fade" id="printbilldiv" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">TABLES</h5>
	  ...
	  <?php  foreach ($tables as $table) { 
	  if($table->payment_status == 'due'){ ?>
		<button class="btn-prni btn-success tablebtn2" data-dismiss="modal" value="<?php  echo $table->id;?>"> <?php  echo $table->name;?></button>  
	 <?php }
	 else{ ?>
	<button class="btn-prni btn-danger tablebtn2" disabled value="<?php  echo $table->id;?>"> <?php  echo $table->name;?></button>	 
	 <?php }
	  } ?>
...
<div class="modal fade" id="smrytdiv" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
 ...
 <div class="box-body">
				...
				<div class="col-lg-6"> 
				 <div class="form-group">
                  ...
                  <input type="date" class="form-control pull-right" name="smry_from_date" id="smry_from_date" value="<?php echo date('Y-m-d')?>">
                </div>
                </div>
				 </div>
				 <div class="col-lg-6"> 
				 <div class="form-group">
                  ...
                  <input type="date" class="form-control pull-right" name="smry_to_date" id="smry_to_date" value="<?php echo date('Y-m-d',strtotime('tomorrow'));?>">
                </div>
                </div>
				 </div>
				</div>
...
<div class="box-footer">
				...
				<input type="button" id="actual_smry" value="VIEW REPORT" class="input btn btn-primary">
              </div>
</form>
            </div>
...
<div class="modal fade" id="srptdiv" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
 ...
 <div class="box-body">
				...
				<div class="col-lg-6"> 
				 ...
				 <div class="form-group">
                  ...
                  <input type="date" class="form-control pull-right" name="actual_to_date" id="actual_to_date" value="<?php echo date('Y-m-d',strtotime('tomorrow'));?>">
                </div>
                </div>
				 </div>
				</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         <?php  foreach ($rooms as $room) { ?>
           <button class="btn-prni btn-primary roomsbtn1" data-dismiss="modal" value="<?php  echo $room->id;?>"> <?php  echo $room->name;?></button>
         <?php }?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        <?php if ($sid) { ?>
        localStorage.setItem('positems', JSON.stringify(<?=$items; die($items);?>));
        <?php } ?>
        ...
        if (localStorage.getItem('pchef')) {
            localStorage.removeItem('pchef');
        }
        
         if (localStorage.getItem('pcashier')) {
            localStorage.removeItem('pcashier');
        }
        ...
        $('#paymentModal').on('change', '#cheque_no_<?=$i?>', function (e) {
         ...
         //addition for mpesa
         $('#paymentModal').on('change', '#mpesa_txn_no_<?=$i?>', function (e) {
            $('#mpesa_txn_no_val_<?=$i?>').val($(this).val());
        });
        //addition for cost center no
        $('#paymentModal').on('change', '#cost_center_no_<?=$i?>', function (e) {
            $('#cost_center_no_val_<?=$i?>').val($(this).val());
        });
    ...
    $startdate = $( "#smry_from_date" ).val();
       ...
       $('#validationModal').on('shown.bs.modal', function(e){
            // $('#quick-payable').click();
            $('#password').focus();
        });
...
//                    $.ajax({
//                                type: "get",
//                                url:site.base_url+"pos/poslogin",
//                                data: {userid: userid, password: password},
//                                dataType: "json",
//                                success: function (data) {
//                                //  alert(data.msg);
//                                if(data.msg==0){
//                                alert('<?="Authentication Failed Please Enter Correct Password"; ?>');    
//                                    
//                                }else{
...
//        });
        ...
        $('#previous').click(function () {
          ...
          $(document).on('change', '#pchef', function () {
            $('#poschef').val($(this).val());
           //$(this).find(":selected").text();
         //alert($(this).val());
          });
          $(document).on('change', '#pcashier', function () {
            $('#poscashier').val($(this).val());
           //$(this).find(":selected").text();
          //alert($(this).val());
          });
        ...
        $(document).on('change', '.paid_by', function () {
            ...
            if (p_val == 'cash' || p_val == 'other') {
                ...
                //get transaction amount here and append on amount field
                ...
                //$('.pcc_' + pa_no).hide();
                //$('.pcash_' + pa_no).show();
                $('#payment_note_' + pa_no).show();
                $('#mpesa_txn_no_' + pa_no).focus();           
            }
            else if (p_val == 'costcenter') {
                $('.pcc_' + pa_no).hide();
                $('.pcash_' + pa_no).hide();
                $('.pcheque_' + pa_no).hide();
                 $('.pcostcenter_' + pa_no).show();
                $('.pmpesa_' + pa_no).hide();
                //$('.pcc_' + pa_no).hide();
                //$('.pcash_' + pa_no).show();
                $('#payment_note_' + pa_no).show();
                $('#cost_center_no_' + pa_no).focus();
            } else {
                $('.pcheque_' + pa_no).hide();
                $('.pcc_' + pa_no).hide();
                $('.pcash_' + pa_no).hide();
        ...
        $(document).on('click', '#submit-sale', function () {
            if( $("#pcashier :selected").val()==""){ //$("#pchef :selected").val()=="" ||
                alert("select chef/cashier");
                return 0;
            }
