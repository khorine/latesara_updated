                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <input name="mpesa_txn_no" type="text" id="mpesarefno" class="form-control  mpesa_txn_no"/>
                            </div>
                                </div>
                            </div> 
                            <div class="col-sm-6" >
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="amount-paid" type="text" id="whole_amount_1" readonly="true"
                        ...
                        <div class="pmpesa_1" style="display:none;">
                            <div class="form-group"><?= 'Mobile Money Transaction Number' ; ?>
                                <input name="mpesa_txn_no1" type="text" id="mpesa_txn_no_1" class="form-control  mpesa_txn_no"/>
                            </div>
                        </div>
  ...
  <div class="modal-dialog modal-sm" role="document">
	...
	<div class="modal-footer"> </div>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-info mpesainfo">MPESA Amount</button>
            <?php echo form_submit('add_mpesa_payment','Add Payment', 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
...
$('#roomsdiv').hide();		   
    ...
    $( "#mpesarefno" ).change(function() {
       // alert($(this).val()+"_"+$('#amount_1').val());
        $("#whole_amount_1").val(0);
         
        
        });
     $('.mpesainfo').click(function () {
			 //alert('tetetete');
			 var mpesaref = $("#mpesarefno").val();
		$.getJSON("https://techsavanna.technology/sipit/mpesa/"+mpesaref, function(data) {

        var amount = data.transAmount;
        $("#whole_amount_1").val(amount);
    });	
