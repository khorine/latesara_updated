    ...
    <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="masthead clearfix">
                <div class="inner">
                    <h3 class="text-center">Stock Manager Advance</h3>
                </div>
            </div>

            <div class="inner cover">
                <h1 class="cover-heading">Stock Manager Advance</h1>
                ...
                <p class="lead">
                    <a href="http://codecanyon.net/item/stock-manager-advance-with-point-of-sale-module/5403161?ref=Tecdiary" class="btn btn-lg btn-primary">Buy Here</a>
                </p>
            </div>
