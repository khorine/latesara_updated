                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_products">
                                ...
                                <ul>
                                   ...
                                   <li id="products_add_kitchen"><a class="submenu" href="<?= site_url('products/add_kitchen'); ?>"><i
                                                class="fa fa-plus-circle"></i><span
                                                class="text"> <?= "Add Kitchen Product";//= lang('add_product'); ?></span></a></li>
                    ...
                    <?php    }
                            ...
                            <li class="mm_transfers">
                                <a class="dropmenu" href="#"><i class="fa fa-star-o"></i><span
                                        class="text"> <?= lang('stock transfers'); ?> </span> <span
                                        class="chevron closed"></span></a>
                                <ul>
                            ...
                            <li class="mm_reports">
                                ...
                                <ul>
                                  ...
                                  <!--  <li id="reports_warehouse_stock"><a
									...
									<li id="reports_stock"><a
                                            href="<?= site_url('reports/stock_sheet') ?>"><i
                                                class="fa fa-building"></i><span
                                                class="text"> <?= lang('Stock_Sheet'); ?></span></a></li>
                                    <?php if (POS) { ?>
