...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#PayRData').dataTable({
            ...
            "aoColumns": [{"mRender": fld}, null, {"mRender": ref}, {"mRender": ref}, null,{"mRender": paid_by}, {"mRender": currencyFormat}, {"mRender": row_status},null],
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                for (var i = 0; i < aaData.length; i++) {
                    if (aaData[aiDisplay[i]][7] == 'sent' || aaData[aiDisplay[i]][7] == 'returned')
            ...
            {column_number: 4, filter_default_label: "[<?=lang('biller_id');?>]", filter_type: "text", data: []},
