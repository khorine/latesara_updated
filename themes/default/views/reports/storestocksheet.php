			...
			<thead class="thead-dark">
				...
				<?php
						...
						foreach ($sheet as $records){
							...
							$r++;
							?>
						<tr style="font-size:11px"><td><?= $r; ?></td><td><?= $records->name; ?></td><td><?= $openingstck; ?></td><td><?= $records->unit; ?></td><td><?= round($records->purchaseqty,0); ?></td><td style="text-align: center"><?= $totals; ?></td><td style="text-align: center"><?= round($stockout,0); ?></td><td>_________</td><td>_________</td><td style="text-align: center"><?= round($records->adjstqty,0); ?></td><td style="text-align: center"><?= $closingstck; ?></td></tr>
							<?php
						}
