    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="row padding10">
                <div class="col-xs-5" style="font-size:13px;font-weight:bold">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped" style="font-size:14px;font-weight:normal;font-family:arial;sans-serif">
                    <thead>
                    <tr class="active">
                        <th><?= lang("no"); ?></th>
                    ...
                    <tr>
                        <td colspan="<?= $col; ?>"
                            style="text-align:right; "><?= lang("total_amount"); ?>
                            (<?= $default_currency->code; ?>)
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;"><?= $this->sma->formatMoney($inv->paid); ?></td>
                    </tr>
                    <tr>
                        <td colspan="<?= $col; ?>" style="text-align:right;"><?= lang("balance"); ?>
                            (<?= $default_currency->code; ?>)
                        </td>
                        <td style="text-align:right; "><?= $this->sma->formatMoney($inv->grand_total - $inv->paid); ?></td>
                    </tr>
