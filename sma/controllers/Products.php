...
//api
    ...
    function getall(){
       //die("sdsd");
        ...
        $products=$this->products_model->getAllProductDetails();
    ...
    function set_rack($product_id = NULL, $warehouse_id = NULL)
    {
        ...
        if ($this->form_validation->run() == true && $this->products_model->setRack($data)) {
			...
			//$wh_pr = $this->site->getproductqtybywarehouse($product_id, $warehouse_id);
    ...
    function add($id = NULL)
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
                ...
                'portion6' => $this->input->post('portion_6'),
                'portion6qty' => $this->sma->formatDecimal($this->input->post('portion_6_qty')),
                'portion7' => $this->input->post('portion_7'),
                'portion7qty' => $this->sma->formatDecimal($this->input->post('portion_7_qty')),
                'portion8' => $this->input->post('portion_8'),
                'portion8qty' => $this->sma->formatDecimal($this->input->post('portion_8_qty')),
                'portion9' => $this->input->post('portion_9'),
                'portion9qty' => $this->sma->formatDecimal($this->input->post('portion_9_qty')),
                'portion10' => $this->input->post('portion_10'),
                'portion10qty' => $this->sma->formatDecimal($this->input->post('portion_10_qty')),
                'portion11' => $this->input->post('portion_11'),
                'portion11qty' => $this->sma->formatDecimal($this->input->post('portion_11_qty')),
                'portion12' => $this->input->post('portion_12'),
                'portion12qty' => $this->sma->formatDecimal($this->input->post('portion_12_qty')),
                'portion13' => $this->input->post('portion_13'),
                'portion13qty' => $this->sma->formatDecimal($this->input->post('portion_13_qty')),
        ...
        if ($this->form_validation->run() == true && $this->products_model->addProduct($data, $items, $warehouse_qty, $product_attributes, $photos)) {
			...
			$this->data['lastid'] = $this->site->getmaxcode();
  ...
  /* ------------------------------------------------------- */
    ...
    function add_kitchen($id = NULL)
    {
        ...
        if ($this->form_validation->run() == true && $this->products_model->addProduct($data, $items, $warehouse_qty, $product_attributes, $photos)) {
            ...
            $this->data['product_options'] = $id ? $this->products_model->getProductOptionsWithWH($id) : NULL;
            $bc = array(array('link' => base_url(), 'page' => lang('home')), array('link' => site_url('products'), 'page' => lang('products')), array('link' => '#', 'page' => lang('add_product')));
            $meta = array('page_title' => "Add Kitchen Product", 'bc' => $bc);
...
//    }
    ...
    function modal_view($id = NULL)
    {
		...
		$this->data['records'] = $this->site->getproductqtybywarehouse($id,31);
		$this->data['bar'] = $this->site->getproductqtybywarehouse($id,32);
...
//ini_set('display_errors', '1');
        ...
        $this->data['purchased'] = $this->products_model->getPurchasedQty($id);
		 $this->data["portion1"]=$this->products_model->getProductByID($pr_details->portion1);
        $this->data["portion2"]=$this->products_model->getProductByID($pr_details->portion2);
        $this->data["portion3"]=$this->products_model->getProductByID($pr_details->portion3);
        $this->data["portion4"]=$this->products_model->getProductByID($pr_details->portion4);
        $this->data["portion5"]=$this->products_model->getProductByID($pr_details->portion5);
		 $this->data["portion6"]=$this->products_model->getProductByID($pr_details->portion6);
        $this->data["portion7"]=$this->products_model->getProductByID($pr_details->portion7);
        $this->data["portion8"]=$this->products_model->getProductByID($pr_details->portion8);
        $this->data["portion9"]=$this->products_model->getProductByID($pr_details->portion9);
        $this->data["portion10"]=$this->products_model->getProductByID($pr_details->portion10);
        $this->data["portion11"]=$this->products_model->getProductByID($pr_details->portion11); 
		 $this->data["portion12"]=$this->products_model->getProductByID($pr_details->portion12);
         $this->data["portion13"]=$this->products_model->getProductByID($pr_details->portion13);
	 $this->data["portion14"]=$this->products_model->getProductByID($pr_details->portion14);
	  $this->data["portion15"]=$this->products_model->getProductByID($pr_details->portion15);
