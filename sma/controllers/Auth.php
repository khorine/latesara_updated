...
//         function poslogin($userid, $password){
//            //print_r($this->auth_model->poslogin($userid, $password)."HA"); 
//           return $this->auth_model->poslogin($userid, $password);
//         }
...
//        $this->session->set_flashdata('message', $this->ion_auth->messages());
//       
//        header("Location: ".$this->config->item('site_base'));
//        //redirect('login/' . $m);
//    }
