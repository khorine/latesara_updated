...
class Purchases_model extends CI_Model
{
	   ...
	   public function updateAVCO($data)
    {
        if ($wp_details = $this->getWarehouseProductQuantity($data['warehouse_id'], $data['product_id'])) {
			...
			$this->db->update('warehouses_products', array('quantity' =>$total_quantity), array('product_id' => $data['product_id'],'warehouse_id' => $data['warehouse_id']));
			//$this->db->update('warehouses_products', array('quantity' => $total_quantity), array('product_id' => $data['product_id'));
            ...
            $this->db->insert('warehouses_products', array('product_id' => $data['product_id'], 'warehouse_id' => $data['warehouse_id'], 'avg_cost' => $data['cost'], 'quantity' => $data['quantity']));
        }
