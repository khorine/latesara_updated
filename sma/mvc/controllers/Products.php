...
class Products extends MY_Controller
{
    ...
    function __construct()
    {
        ...
        function connect_db(){
         $mysqli=new mysqli("localhost","root","","techsava_restaurant");
  ...
  /* ------------------------------------------------------- */
    ...
    function add_kitchen($id = NULL)
    {
        ...
        $whproducts = $this->products_model->getProductsByWarehouseID(2);
        //$warehouseproducts = $this->site->getAllWarehouses();
        if ($this->input->post('type') == 'standard') {
            $this->form_validation->set_rules('cost', lang("product_cost"), 'required');
        }
        if ($this->input->post('barcode_symbology') == 'ean13') {
        ...
        if ($this->form_validation->run() == true) {
            $tax_rate = $this->input->post('tax_rate') ? $this->site->getTaxRateByID($this->input->post('tax_rate')) : NULL;
             $name = $this->products_model->getStimaItemByID($this->input->post('name')); 
            // $category = $this->products_model->getStimaCategoryByID($this->input->post('category')); 
           
             $data = array(
                'code' => $this->input->post('code'),
                'barcode_symbology' => $this->input->post('barcode_symbology'),
              
                'name' => $name->menu_name,//$this->input->post('name'),
                'type' => $this->input->post('type'),
                'category_id' => $this->input->post('category'),
                'subcategory_id' => $this->input->post('subcategory'),
                'cost' => $this->sma->formatDecimal($this->input->post('cost')),
                ...
                'iskitchen' =>1,//$this->input->post('iskitchen'),
                'portion1' => $this->input->post('portion'),
                'portion1price' => $this->sma->formatDecimal($this->input->post('portion_qty')),
                'portion2' => $this->input->post('portion_2'),
                'portion2price' => $this->sma->formatDecimal($this->input->post('portion_2_qty')),
                'portion3' => $this->input->post('portion_3'),
                'portion3price' => $this->sma->formatDecimal($this->input->post('portion_3_qty')),
                'portion4' => $this->input->post('portion_4'),
                'portion4price' => $this->sma->formatDecimal($this->input->post('portion_4_qty')),
                'portion5' => $this->input->post('portion_5'),
                'portion5price' => $this->sma->formatDecimal($this->input->post('portion_5_qty')),
                'portion6' => $this->input->post('portion_6'),
                'portion6price' => $this->sma->formatDecimal($this->input->post('portion_6_qty')),
                'portion7' => $this->input->post('portion_7'),
                'portion7price' => $this->sma->formatDecimal($this->input->post('portion_7_qty')),
                'portion8' => $this->input->post('portion_8'),
                'portion8price' => $this->sma->formatDecimal($this->input->post('portion_8_qty')),
                'portion9' => $this->input->post('portion_9'),
                'portion9price' => $this->sma->formatDecimal($this->input->post('portion_9_qty')),
                'portion10' => $this->input->post('portion_10'),
                'portion10price' => $this->sma->formatDecimal($this->input->post('portion_10_qty')),
                'portion11' => $this->input->post('portion_11'),
                'portion11price' => $this->sma->formatDecimal($this->input->post('portion_11_qty')),
                'portion12' => $this->input->post('portion_12'),
                'portion12price' => $this->sma->formatDecimal($this->input->post('portion_12_qty')),
                'portion13' => $this->input->post('portion_13'),
                'portion13price' => $this->sma->formatDecimal($this->input->post('portion_13_qty')),
        ...
        if ($this->form_validation->run() == true && $this->products_model->addProduct($data, $items, $warehouse_qty, $product_attributes, $photos)) {
            ...
            $this->data['tax_rates'] = $this->site->getAllTaxRates();
            $this->data['warehouses'] = $warehouses;
            $this->data['whproducts'] = $whproducts;
            $this->data['warehouses_products'] = $id ? $this->products_model->getAllWarehousesWithPQ($id) : NULL;
            $this->data['product'] = $id ? $this->products_model->getProductByID($id) : NULL;
            $this->data['variants'] = $this->products_model->getAllVariants();
            $this->data['combo_items'] = ($id && $this->data['product']->type == 'combo') ? $this->products_model->getProductComboItems($id) : NULL;
